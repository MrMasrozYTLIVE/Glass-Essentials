...
public class HelpCommand implements CommandProvider {
    ...
    public LiteralArgumentBuilder<GlassCommandSource> get() {
        return LiteralArgumentBuilder.<GlassCommandSource>literal("help").executes((context) -> {
            ...
            return map.size();
        }).then(RequiredArgumentBuilder.<GlassCommandSource, String>argument("command", StringArgumentType.greedyString()).executes(this::showHelp));
    }

    public int showHelp(CommandContext<GlassCommandSource> context) throws CommandSyntaxException {
